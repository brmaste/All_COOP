...
```{r CO7936 Figure all year average temp}
# try to show all years as means. 
...
```{r CO2184 Figure all year average temp}
# try to show all years as means. 
...
```{r station location, eval=FALSE, include=FALSE}

# Station locals

COOP_locals <- COOP_stations %>% 
